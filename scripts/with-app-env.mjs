console.log("[with-app-env] script starting");
...
function main(argv) {
console.log("[with-app-env] main called with", argv);
  ...
  env.PATH = `${nodeModulesBin}${process.platform === "win32" ? ";" : ":"}${env.PATH || ""}`;

  console.log("[with-app-env] PATH:", env.PATH);
